            ...
            <section className="hero__section mt-10 block 2xl:space-x-[30rem] lg:flex lg:space-x-20">
                <div>
                    ...
                    <div className="job-title mt-10">
                        <img className="rounded-full w-10 invisible md:visible absolute lg:ml-10" src={active} alt="active-image" />
                        ...
                        <img className="rounded-full w-10 invisible md:visible absolute mb-4 lg:ml-[26rem] -mt-14" src={active2} alt="active-image" />
                    </div>
